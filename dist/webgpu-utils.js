(function (global, factory) {
  ...
  function getNoiseCode() {
    ...
    if (!exports.noiseBuffer) {
      exports.noiseBuffer = new Buffer('noiseOffset', [Math.random() * 1000, Math.random() * 1000, Math.random() * 1000], 'noiseOffset');
    }
...
`;
  ...
  function createMouseBuffer() {
      ...
      exports.mouseBuffer = mouseStruct.createBuffer('mouse', mouseStruct.object());
      const mouseEvent = (e) => {
          ...
          exports.mouseBuffer.update(new Float32Array([
              exports.width * (e.clientX - rect.left) / rect.width,
              exports.height * (e.clientY - rect.top) / rect.height,
              mouseIsDown
          ]));
      };
   ...
   */
  exports.timeBuffer = null;
  function getTimeBuffer() {
      if (!exports.timeBuffer) {
          throw new Error('getTimeBuffer: Time buffer has not been created yet');
      }
      return exports.timeBuffer;
  }
  function createTimeBuffer() {
      exports.timeBuffer = new Buffer('time', new Float32Array([0]));
      setInterval(() => {
          exports.timeBuffer.update(new Float32Array([performance.now() / 1000]));
  ...
  class RenderPass {
      constructor(texture, code) {
          ...
          try {
              this.module = exports.device.createShaderModule({ code });
              this.pipeline = exports.device.createRenderPipeline({
                  layout: 'auto',
                  vertex: { module: this.module, entryPoint: 'vs' },
                  fragment: { module: this.module, entryPoint: 'fs', targets: [{ format: exports.canvasPresentationFormat }] },
              });
              this.sampler = exports.device.createSampler({ magFilter: 'linear', minFilter: 'linear' });
              this.bindGroup = exports.device.createBindGroup({
      ...
      run(encoder) {
          try {
              this.renderPassDescriptor.colorAttachments[0].view = exports.ctx.getCurrentTexture().createView();
  ...
  class ComputePass {
      constructor(code, bindings, dispatchSize, entryPoint = 'main') {
          ...
          const Auto_Bindings = [
              { binding: exports.mouseBuffer, regex: /\bmouse(\.(pos|button))?\b/ },
              { binding: exports.timeBuffer, regex: /\btime\b/ },
              { binding: exports.renderTxtr, regex: /\brenderTxtr\b/, function: 'write' },
              { binding: exports.feedbackTxtr, regex: /\bfeedbackTxtr\b/, function: 'read' },
          ];
          ...
          this.module = exports.device.createShaderModule({ code });
          this.pipeline = exports.device.createComputePipeline({
              layout: 'auto',
      ...
      static texture(code, bindings){
          return new ComputePass(code, bindings, [exports.width, exports.height]);
      }
  ...
  function runPasses(passes, repeats = 1) {
      ...
      try {
          const commandEncoder = exports.device.createCommandEncoder();
          ...
          exports.device.queue.submit([commandEncoder.finish()]);
      } catch (error) {
   ...
   * @type {Array}
   */
  exports.renderTxtr = void 0; exports.feedbackTxtr = void 0;
  exports.renderPass = void 0; exports.matchPass = void 0; exports.clearPass = void 0;
  ...
  async function createRenderPass(options = {}) {
      ...
      exports.renderPass = new RenderPass(exports.renderTxtr, basicRenderCode);
      return exports.renderPass;
  }
  ...
  async function createTextures() {
      try {
          exports.renderTxtr = new Texture('renderTxtr', exports.width, exports.height);
          exports.feedbackTxtr = new Texture('feedbackTxtr', exports.width, exports.height);
        ...
        fn main(@builtin(global_invocation_id) id: vec3<u32>) {
          ...
          const pass1 = new ComputePass(code, [exports.renderTxtr.write(), exports.feedbackTxtr.write()], [exports.width, exports.height]);
          runPasses([pass1]);
      } catch (error) {
  ...
  async function createMatchPass() {
      if (!exports.renderTxtr || !exports.feedbackTxtr) {
    ...
    fn main(@builtin(global_invocation_id) id: vec3<u32>) {
      ...
      exports.matchPass = new ComputePass(code, [exports.renderTxtr.read(), exports.feedbackTxtr.write()], [exports.width, exports.height]);
      return exports.matchPass;
  }
  ...
  async function createClearPass() {
    ...
    fn main(@builtin(global_invocation_id) id: vec3<u32>) {
      ...
      exports.clearPass = new ComputePass(code, [exports.renderTxtr.write(), exports.feedbackTxtr.write()], [exports.width, exports.height]);
      return exports.clearPass;
  }
  ...
  exports.width = void 0; exports.height = void 0; exports.device = void 0;
  exports.canvas = void 0; exports.canvasPresentationFormat = void 0; exports.ctx = void 0;
  ...
  async function initCanvas(options = {}) {
      ...
      try {
          ...
          exports.device = await adapter.requestDevice();
          if (!exports.device) {
              throw new Error('Couldn\'t request WebGPU device.');
          }

          // Set up error handling for device
          exports.device.addEventListener('uncapturederror', (event) => {
              console.error('WebGPU device error:', event.error);
          });

          // Get or create canvas
          exports.canvas = options.canvas || document.querySelector('canvas');
          if (!exports.canvas) {
          ...
          if (options.containerId) {
              ...
              exports.width = container.clientWidth;
              exports.height = container.clientHeight;
              exports.canvas.style.display = 'block';
          } else {
              if (!options.canvas) {
          ...
          if (options.width) exports.width = options.width;
          if (options.height) exports.height = options.height;

          exports.canvas.style.width = exports.width + 'px';
          exports.canvas.style.height = exports.height + 'px';
          exports.width *= 2;
          exports.height *= 2;
          ...
          exports.ctx = exports.canvas.getContext('webgpu');
          if (!exports.ctx) {
              throw new Error('Couldn\'t get WebGPU context from canvas.');
          }

          exports.canvasPresentationFormat = navigator.gpu.getPreferredCanvasFormat();
          exports.ctx.configure({
              device: exports.device,
              format: exports.canvasPresentationFormat,
          ...
          window.addEventListener('keydown', (e) => {
              if (e.key === 's') {
                  ...
                  a.href = exports.canvas.toDataURL();
          ...
          return { device: exports.device, canvas: exports.canvas, width: exports.width, height: exports.height };
      } catch (error) {
  ...
  class Buffer {
      ...
      constructor(name, data) {
          ...
          try {
              ...
              this.buffer = exports.device.createBuffer({
                  label: this.name,
                  size: this.size,
      ...
      update(data) {
          ...
          try {
              ...
              // Update data
              exports.device.queue.writeBuffer(this.buffer, 0, data);
              this.data = data;
          } catch (error) {
      ...
      async getData(){
          ...
          const readBuffer = exports.device.createBuffer({
              size: this.size,
          ...
          exports.device.queue.submit([commands]);
  ...
  class Texture {
      ...
      constructor(name = '', width = 512, height = 512, format = 'rgba8unorm') {
          ...
          try {
              ...
              // Create the texture
              this.texture = exports.device.createTexture({
                  label: this.name,
                  size: [width, height, 1],
                  format,
  ...
  function getCamStuff(options = {}) {
    ...
    const ASPECT_RATIO = ${exports.width / exports.height};
...
`;
  ...
  function createGetRayFunction(options = {}) {
      const customCameraCode = options.customCameraCode || exports.cameraCode;
...
`;
  ...
  function wgsl(strings, ...values) {
    ...
    code = code.replace(/\bwidth\b/g, exports.width.toFixed(2));
  ...
  exports.basicRenderCode = basicRenderCode;
  exports.choose = choose;
  exports.createClearPass = createClearPass;
  exports.createFirstPersonCamera = createFirstPersonCamera;
  exports.createGetRayFunction = createGetRayFunction;
  exports.createMatchPass = createMatchPass;
  exports.createMouseBuffer = createMouseBuffer;
  exports.createRenderPass = createRenderPass;
  exports.createStaticCamera = createStaticCamera;
  exports.createTextures = createTextures;
  exports.createTimeBuffer = createTimeBuffer;
  exports.domReady = domReady;
  exports.extractFunctionsAndBody = extractFunctionsAndBody;
  exports.getCamStuff = getCamStuff;
  exports.getNoiseCode = getNoiseCode;
  exports.getTimeBuffer = getTimeBuffer;
  exports.init = init;
  ...
  exports.setCameraCode = setCameraCode;
  exports.timeout = timeout;
  exports.type_color = type_color;
  exports.type_f32 = type_f32;
  exports.type_vec2 = type_vec2;
  exports.type_vec3 = type_vec3;
  exports.type_vec4 = type_vec4;
  exports.wgsl = wgsl;
  exports.wgslFBM = wgslFBM;
  exports.wgslNoise = wgslNoise;
  exports.wgslNoise2 = wgslNoise2;
  exports.wgslNoise3 = wgslNoise3;
  exports.wgslVoronoi = wgslVoronoi;
  exports.wgsl_material = wgsl_material;
  exports.wgsl_normals = wgsl_normals;
  exports.wgsl_rayStruct = wgsl_rayStruct;
  exports.wgsl_rayToBox = wgsl_rayToBox;
  exports.wgsl_rayToPlane = wgsl_rayToPlane;
  exports.wgsl_rayToSphere = wgsl_rayToSphere;
  exports.wgsl_rotate = wgsl_rotate;
  exports.wgsl_rotate_y = wgsl_rotate_y;
